...
import CoreLocation
import GoogleMaps
class PickUpVC: UIViewController, UISearchBarDelegate ,UITableViewDelegate, UITableViewDataSource  {
...
//MARK: - Search Bar delegates
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if tableView == tblViewSearchLocation {
            ...
            protocolRideConfigHome?.pickUpSelected(selectedLocation: selectedLocation)
            tblViewSearchLocation.isHidden = true
        } else {
